...
Building Plugins
----------------
You get started with Sampling plugin by building directly from the latest source code::

  git clone https://github.com/hydrator/sampling-aggregator.git
  cd sampling-aggregator
  mvn clean package
...
You can deploy a plugin using the CDAP CLI::
  ...
  > load artifact target/sampling-aggregator-plugin-<version>.jar \
         config-file target/sampling-aggregator-plugin-<version>.json
